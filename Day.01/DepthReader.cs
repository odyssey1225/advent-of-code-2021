...
namespace Day01
{
    public class DepthReader
    {
        ...
        private int GetDepthIncreases()
        {
            ...
            for (var i = 1; i < _depthSamples.Count; i++)
            {
                if (_depthSamples.ElementAt(i) > _depthSamples.ElementAt(i - 1))
                    increases++;
            }
    ...
    public static class DepthSamples
    {
        public static ICollection<int> AllSamples = new List<int>
        {
            170
            ,176
            ,179
